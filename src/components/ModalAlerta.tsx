...
const ModalAlerta: React.FC<ModalAlertaProps> = ({ title, message, onCancel, onConfirm }) => {
    return (
        <div className="fixed inset-0 bg-[#fff] flex items-center justify-center z-50 top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] p-[2rem] rounded-[1rem] w-[35rem]" style={{ boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
